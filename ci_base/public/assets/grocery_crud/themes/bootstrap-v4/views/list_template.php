                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-default btn-sm btn-outline-dark" href="<?php echo $add_url?>">
                            ...
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <a class="btn btn-default btn-outline-dark btn-sm t5 gc-export" data-url="<?php echo $export_url; ?>" href="javascript:;">
                                ...
                                <?php } ?>
                                <?php if(!$unset_print) { ?>
                                    <a class="btn btn-default btn-outline-dark btn-sm t5 gc-print" data-url="<?php echo $print_url; ?>" href="javascript:;">
                                ...
                                <tr class="filter-row gc-search-row">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <input
                                                    type="text"
                                                    class="form-control searchable-input form-control-sm floatL"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
